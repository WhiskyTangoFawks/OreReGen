...
execute if predicate du:location/biome_types/savanna run scoreboard players set $density ore.generator 20
...
#Turn sand to clay in swamps instead of generating gold
