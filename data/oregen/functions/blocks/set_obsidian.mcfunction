...
execute unless predicate du:location/biome_types/taiga if predicate du:random/0.5 unless score $block_set ore.vein matches 1 store result score $block_set ore.vein run fill ~ ~ ~ ~ ~ ~ minecraft:magma_block replace minecraft:stone
execute if predicate du:location/biome_types/taiga if predicate du:random/0.5 unless score $block_set ore.vein matches 1 store result score $block_set ore.vein run fill ~ ~ ~ ~ ~ ~ minecraft:ice replace minecraft:stone
...
execute unless predicate du:location/biome_types/taiga if predicate du:random/0.5 unless score $block_set ore.vein matches 1 store result score $block_set ore.vein run fill ~ ~ ~ ~ ~ ~ minecraft:lava replace minecraft:stone
execute if predicate du:location/biome_types/taiga if predicate du:random/0.5 unless score $block_set ore.vein matches 1 store result score $block_set ore.vein run fill ~ ~ ~ ~ ~ ~ minecraft:packed_ice replace minecraft:stone